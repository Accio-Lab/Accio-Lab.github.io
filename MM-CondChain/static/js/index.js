    ...
    draw() {
        ...
        this.particles.forEach((p1, i) => {
            this.particles.slice(i + 1).forEach(p2 => {
                ...
                if (distance < 100) {
                    this.ctx.beginPath();
                    this.ctx.strokeStyle = `rgba(79, 140, 255, ${0.2 * (1 - distance / 100)})`;
        ...
        this.particles.forEach(particle => {
            ...
            this.ctx.fillStyle = `rgba(79, 140, 255, ${particle.opacity})`;
            this.ctx.fill();
        });
    }
...
function addSparkleEffect() {
    ...
    title.addEventListener('mouseenter', () => {
        title.style.textShadow = '0 0 20px rgba(79, 140, 255, 0.5), 0 0 40px rgba(107, 183, 255, 0.3)';
    });
